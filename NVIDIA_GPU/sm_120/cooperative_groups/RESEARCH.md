...
| 图表 | 描述 |
|------|------|
| `sync_overhead.png` | 同步开销对比 |
| `grid_sync_performance.png` | Grid 同步性能 |
| `reduction_comparison.png` | 归约方法对比 |
| `coop_load_speedup.png` | Cooperative Load 加速 |
| `broadcast_performance.png` | Broadcast 性能 |
| `barrier_efficiency.png` | Barrier 效率 |
