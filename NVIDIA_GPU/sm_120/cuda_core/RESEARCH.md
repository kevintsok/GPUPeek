...
| FP64 | 65.81 GFLOPS | ~2300 GFLOPS | ~2.9% | **内存带宽限制** |
| FP16 | 302.96 GFLOPS | N/A | N/A | **CUDA Core** |
| BF16 | 354.21 GFLOPS | N/A | N/A | **CUDA Core** |
| INT8 | 313.26 GIOPS | N/A | N/A | **CUDA Core** |
...
| 指令类型 | 吞吐量 | 延迟 | 说明 |
|---------|--------|------|------|
| FP32 FMA | 268.49 GFLOPS | 0.015 ms | 内存带宽限制 |
| FP64 FMA | 65.81 GFLOPS | 0.015 ms | CUDA Core |
| FP16 FMA | 302.96 GFLOPS | 0.014 ms | CUDA Core |
| BF16 FMA | 354.21 GFLOPS | 0.014 ms | CUDA Core |
| INT32 | 259.08 GIOPS | 0.014 ms | 内存带宽限制 |
| INT8 | 313.26 GIOPS | 0.014 ms | CUDA Core |
