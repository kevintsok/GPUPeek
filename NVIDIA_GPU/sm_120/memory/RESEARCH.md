...
| 数据大小 | 状态 | 读取带宽 | 写入带宽 |
|---------|------|----------|----------|
| 1 KB | 寄存器/L1 | 0.04 GB/s | 0.04 GB/s |
| 64 KB | L1 缓存 | 8.09 GB/s | 8.09 GB/s |
| 256 KB | L1/L2 边界 | 29.73 GB/s | 29.73 GB/s |
| 1 MB | L2 缓存 | 97.02 GB/s | 97.02 GB/s |
| 4 MB | L2 缓存 | 380.18 GB/s | 380.18 GB/s |
| 16 MB | **峰值** | **842.76 GB/s** | 842.76 GB/s |
| 64 MB | L2 miss → DRAM | 343.84 GB/s | 343.84 GB/s |
| 128 MB | DRAM | 477.99 GB/s | 477.99 GB/s |
| 256 MB | DRAM | 572.70 GB/s | 572.70 GB/s |

**关键发现**:
- 峰值带宽实测 **842.76 GB/s** (16MB 工作集，L2 完全缓存)
- 小数据尺寸受 kernel 启动开销影响较大
- L2 缓存峰值约 380.18 GB/s (4MB)
- DRAM 带宽在 343-573 GB/s 范围 (64MB+)
...
**关键发现**: 共享内存带宽实测 1.54 TB/s，显著高于全局内存 (~800 GB/s)
