...
本项目对Apple M2 GPU进行了深度研究，通过60个模块化基准测试分析其架构特性和性能特征。
...
| IndirectAddressing | [Link](Memory/IndirectAddressing/RESEARCH.md) | 随机索引访问比顺序慢2-5x |
| LocalMemory | [Link](Memory/LocalMemory/RESEARCH.md) | Threadgroup内存延迟~10-20 cycles |
...
| PipelineBubbles | [Link](Compute/PipelineBubbles/RESEARCH.md) | 依赖操作导致流水线停顿 |
...
| TridiagonalMatrix | [Link](Algorithms/TridiagonalMatrix/RESEARCH.md) | Thomas算法O(n)三对角求解 |
| HeatEquation | [Link](Algorithms/HeatEquation/RESEARCH.md) | Jacobi迭代/PDE热方程求解 |
| BitonicSort | [Link](Algorithms/BitonicSort/RESEARCH.md) | O(log²n)并行排序网络 |
| BucketSort | [Link](Algorithms/BucketSort/RESEARCH.md) | O(n)分布排序/哈希分发 |
| RaySphereIntersection | [Link](Algorithms/RaySphereIntersection/RESEARCH.md) | 光线追踪基元/碰撞检测 |
| PredicateMasking | [Link](Algorithms/PredicateMasking/RESEARCH.md) | 谓词过滤/线程掩码跳过无效工作 |
| DatabaseOps | [Link](Algorithms/DatabaseOps/RESEARCH.md) | 并行过滤/聚合/排序操作 |
...
| Quantization | [Link](Analysis/Quantization/RESEARCH.md) | Int8/Int4量化减少内存4x |
| DataLayout | [Link](Analysis/DataLayout/RESEARCH.md) | SoA比AoS缓存效率高2-4x |
...
| AsyncOperations | [Link](Optimization/AsyncOperations/RESEARCH.md) | 异步提交实现CPU/GPU重叠 |
| MultiQueue | [Link](Optimization/MultiQueue/RESEARCH.md) | 多队列并行执行内核 |
| ShaderCompiler | [Link](Optimization/ShaderCompiler/RESEARCH.md) | 编译开销和launch优化 |
| IndirectCommand | [Link](Optimization/IndirectCommand/RESEARCH.md) | GPU驱动的命令生成 |
